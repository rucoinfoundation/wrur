 ...
 * controlled by a central SupplyController. By implementing Wrapped RUR
...
contract WRUR {
    ...
    string public constant name = "WRUR"; // solium-disable-line
    string public constant symbol = "WRUR"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all WRUR at the contract address.
     * This sends the WRUR tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimWRUR() external onlyOwner {
